...
public class AlarmActivity extends Activity {
    private static final String TAG = "OliveDeliveryAlarmActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (pm != null) {
                ...
                PowerManager.WakeLock wl = pm.newWakeLock(
                    ...
                    "OlivePizzaDelivery::AlarmActivityScreenOn"
                );
                wl.acquire(30000);
                wakeLock = wl;
            }
        ...
        if (orderId == null) orderId = "New Delivery";

        // 3. Native Delivery Alert UI
        LinearLayout layout = new LinearLayout(this);
        layout.setOrientation(LinearLayout.VERTICAL);
        layout.setGravity(Gravity.CENTER);
        layout.setBackgroundColor(Color.parseColor("#090E17")); // Olive Dark Blue/Black theme
        ...
        title.setText("NEW DELIVERY ASSIGNMENT!");
        ...
        subtitle.setText("Delivery Order #" + (orderId.length() > 6 ? orderId.substring(orderId.length() - 6).toUpperCase() : orderId) + " assigned to you.");
        ...
        stopBtn.setText("VIEW & ACCEPT DELIVERY");
